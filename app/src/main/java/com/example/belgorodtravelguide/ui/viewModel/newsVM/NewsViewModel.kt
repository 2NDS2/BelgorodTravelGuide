package com.example.belgorodtravelguide.ui.viewModel.newsVM
...
import com.example.belgorodtravelguide.data.local.api.NewsArticle
import com.example.belgorodtravelguide.data.local.api.NewsResponse
import com.example.belgorodtravelguide.data.local.api.RetrofitInstance
...
class NewsViewModel(private val newsRepository: NewsRepository, private val context: Context) : ViewModel() {
    ...
    private fun saveNewsToDatabase(newsList: List<NewsArticle>) {
        viewModelScope.launch {
            withContext(Dispatchers.IO) {
                ...
                newsRepository.insertNews(newsEntities)  // Вставляем все записи за один раз
            }
        }
    }
